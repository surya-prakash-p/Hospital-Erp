...
export async function createStaffUser(userData) {
  ...
  const existingStaff = staff.find(s => 
    (s.email && userData.email && s.email.toLowerCase() === userData.email.toLowerCase()) || 
    (s.mobile_no && userData.mobile_no && s.mobile_no === userData.mobile_no)
  );
  ...
  const newStaffMember = {
    ...
    email: userData.email || (existingStaff ? existingStaff.email : ''),
    mobile_no: userData.mobile_no || (existingStaff ? existingStaff.mobile_no : ''),
    password: userData.password || (existingStaff ? existingStaff.password : ''),
