...
export function isUserDeleted(identifier) {
...
export function findServerUserByIdentifier(identifier) {
...
export function findServerUser(identifier, password) {
  const found = findServerUserByIdentifier(identifier);
...
export function deleteServerUser(identifier) {
  ...
  saveDeletedUsersFile(deletedList);
